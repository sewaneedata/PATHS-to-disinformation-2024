...
This project, PATHS to Disinformation, analyzed two datasets provided by YouGov (370 participants) and Forthright (584 participants) that tracked the participants' browsing histories in a period that spanned 3-4 months. The goals of this analysis were to map the digital pathways of these individuals, identify the online platforms that lead them to disinformation, and interpret the relationship between their political affiliations and their exposure to disinformation.
...
In the second script, `explore_forthright.R`, the focus is on examining the behavior of users who visited disinformation sites by using both the Ideology list and the disinformation list. A key element of this script is the creation of Alluvial Diagrams to illustrate paths to disinformation. The latter part of the script includes analysis answering questions about the data, such as the number of users who accessed fake news sites.
...
In the YouGov dataset, the paths taken by the participants, whether they are left-wing or right-wing, were consistent. Audiences tend to stick to their preferred media diet, as right-wing individuals prefer Fox News (right-biased site) and left-wing individuals prefer CNN (left-biased site). Surprisingly, more right-wing individuals stay on their similarly-aligned media site compared to left wing. As in the case of left-wing individuals, the majority prefer to continue browsing after.

The analysis of partisan media visits from YouGov indicates that there is more left-aligned media than right-aligned media. However, no matter which of the biases they lean towards, audiences from both sides still prefer their similarly-aligned news source more. 
